...
//Optional solution 1 without mongoose// /*Check optonal solution 2 with mongoose*/
...
//1.Creating a function to manage local file storage (File data.json)
function dataManagement(action, input) {
  let filePath = './public/data.json';
  //checking if file exist -> create a new file if not
...
//2.Creating a function for random short_url (using Math.random())
...
//3.Having my middleware to handle user url input
